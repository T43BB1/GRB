import curses
from tui.select_diagnosis_check import select_diagnosis_check

def select_diagnosis_target(stdscr, checklist, result):
    ...
    while True:
        ...
        if key == curses.KEY_UP and current_row > 0:
            ...
            if current_row == len(targets) - 1:  # "뒤로" 선택 시
                ...
                target = select_diagnosis_check(stdscr, checklist[targets[current_row]], result, targets[current_row])
                return target
                break
